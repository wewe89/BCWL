...
public class VideoRecorderActivity extends ActionBarActivity implements
        OnClickListener, SurfaceHolder.Callback, OnErrorListener,
        OnInfoListener {

    private final static String CLASS_LABEL = "RecordActivity";
    private final static String TAG = makeLogTag(VideoRecorderActivity.class);
    ...
    private boolean initCamera() {
        try {
            ...
            LOGE(TAG, "init Camera fail " + ex.getMessage());
            return false;
        }
        return true;
    }
    ...
    private void handleSurfaceChanged() {
        ...
        // 获取摄像头的所有支持的分辨率
        List<Size> resolutionList = VersionUtil.getResolutionList(mCamera);
        if (resolutionList != null && resolutionList.size() > 0) {
            Collections.sort(resolutionList, new VersionUtil.ResolutionComparator());
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.switch_btn)
            ...
            new AlertDialog.Builder(this)
                    .setMessage("是否发送？")
                    .setPositiveButton(R.string.video_ok,
                    ...
                    .setNegativeButton(R.string.video_cancle,
                            new DialogInterface.OnClickListener() {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        try {
            ...
            LOGE(TAG, "start preview fail " + e1.getMessage());
        }
    }

    @Override
    public void surfaceDestroyed(SurfaceHolder arg0) {
        LOGV(TAG, "surfaceDestroyed");
    ...
    public void stopRecording() {
        if (mediaRecorder != null) {
            ...
            try {
                ...
                LOGE(TAG, "stopRecording error:" + e.getMessage());
            }
        }
        releaseRecorder();
    ...
    public void sendVideo(View view) {
        if (TextUtils.isEmpty(localPath)) {
            LOGE(TAG, "recorder fail please try again!");
            return;
        }
        ...
        if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.video_ok,
                            ...
                            }).setNegativeButton(R.string.video_cancle, null)
                    .setCancelable(false).show();
        }
