...
public class NetworkStatusManager {
    ...
    private static final String TAG = makeLogTag(NetworkStatusManager.class);
    ...
    private class ConnectivityBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!action.equals(ConnectivityManager.CONNECTIVITY_ACTION) || mListening == false) {
                LOGV(TAG, "onReceived() called with " + mState.toString() + " and " + intent);
                return;
            }
            ...
            mIsFailover = intent.getBooleanExtra(ConnectivityManager.EXTRA_IS_FAILOVER, false);
                LOGD(TAG, "onReceive(): mNetworkInfo=" + mNetworkInfo + " mOtherNetworkInfo = " + (mOtherNetworkInfo == null ? "[none]" : mOtherNetworkInfo + " noConn=" + noConnectivity)
