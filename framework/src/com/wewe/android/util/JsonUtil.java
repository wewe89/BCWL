...
public class JsonUtil {
    public static Object string2bean(String str, Class cls) {
        try {
    ...
    public static JSONObject bean2json(Object o) throws Exception {
     ...
     * 将list转换成JSONArray
     */
    public static JSONArray list2jsonarray(List list) throws Exception {
