package com.wewe.android.fragment;
...
import com.wewe.android.activity.VideoRecorderActivity;
import com.wewe.android.domain.VideoEntity;
import com.wewe.android.util.DateUtils;
import com.wewe.android.util.TextFormater;
import com.wewe.android.util.VersionUtil;
import com.wewe.android.util.video.ImageCache;
import com.wewe.android.util.video.ImageResizer;
import com.wewe.android.widget.RecyclingImageView;
...
public class VideoGridFragment extends Fragment implements OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        final View v = inflater.inflate(R.layout.fragment_video_grid,
                container, false);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if (position == 0) {
                ...
                holder.imageView.setImageResource(R.drawable.video_camera_icon);
            } else {
