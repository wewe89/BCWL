...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void setSelectedIndicatorColors(int... colors) {
        mSelectedIndicatorColors = colors;
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextColor(getResources().getColor(TAB_VIEW_TEXT_COLOR));
    ...
    private int TAB_VIEW_TEXT_COLOR = R.color.black;

    public void setDefaultTabTextColor(int color) {
        TAB_VIEW_TEXT_COLOR = color;
    }
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                ...
                if (tabView instanceof TextView) {
                    ...
                    if (position == i) {
                        tv.setTextColor(mTabStrip.getSelectedIndicatorClolor(i));
                    } else tv.setTextColor(getResources().getColor(TAB_VIEW_TEXT_COLOR));
                }
            }
            if (mViewPagerPageChangeListener != null) {
