...
/**
 * User:wewecn on 2015/7/6 14:34
 * Email:wewecn@qq.com
 */
public class DataPickWheelDialog extends PopupWindow implements View.OnClickListener {
    ...
    public DataPickWheelDialog(Context paramContext) {
        super(paramContext);
    ...
    private WheelView mCityView, mCountyView;
